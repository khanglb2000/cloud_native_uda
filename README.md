...
6. `kubectl apply -f deployment/udaconnect-connection.yaml` - Set up the service and deployment for the connection API
7. `kubectl apply -f deployment/udaconnect-persons` - Set up the service of the persons api and microservice.
8. `kubectl apply -f deployment/udaconnect-location-consumer.yaml` - Set up the consumer service of the location microservice.
9. `kubectl apply -f deployment/udaconnect-location-producer` - Set up the producer service of the location microservice.
...
12. The commands used are also found under _udaconnect-project/scripts/deployment_build.sh_
